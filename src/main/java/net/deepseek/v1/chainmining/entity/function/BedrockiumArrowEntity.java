...
public class BedrockiumArrowEntity extends PersistentProjectileEntity {
//    protected BedrockiumArrowEntity(EntityType<? extends PersistentProjectileEntity> entityType, World world) {
