...
public class ModItems {
    ...
    public static final Item BEDROCKIUM_ARROW = register("bedrockium_arrow",
            (settings) -> new BedrockiumArrowItem(settings.maxCount(64)
    ...
    public static final Item ICE_CLAW = register("ice_claw",
            (settings) -> new IceClawItem(settings.maxCount(1).maxDamage(800000)
    ...
    public static final Item BEDROCKIUM_BOW = register("bedrockium_bow",
            (settings) -> new BedrockiumBowItem(settings.maxCount(1)
                    .maxDamage(8000000)
