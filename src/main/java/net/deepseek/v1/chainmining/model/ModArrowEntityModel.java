package net.deepseek.v1.chainmining.model;
...
public class ModArrowEntityModel extends EntityModel<ProjectileEntityRenderState> {
    public ModArrowEntityModel(ModelPart modelPart) {
